...
GO
PRINT N'Altering Procedure [dbo].[spi_cuenta]...';


GO
ALTER PROCEDURE [dbo].[spi_cuenta]
(
...
GO
PRINT N'Altering Procedure [dbo].[spi_orden]...';


GO
ALTER PROCEDURE [dbo].[spi_orden]
(
	@Request		nvarchar(max)
...
GO
PRINT N'Altering Procedure [dbo].[sp_procesaorden]...';


GO
ALTER PROCEDURE [dbo].[sp_procesaorden]
(
	@Request		nvarchar(max)
)
as
